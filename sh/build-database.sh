...
psql -h 127.0.0.1 -U $DB_USER  -f ./db/clear-db.sql $DB_NAME
psql -h 127.0.0.1 -U $DB_USER  -f ./db/schema.sql $DB_NAME
psql -h 127.0.0.1 -U $DB_USER  -f ./db/functions.sql $DB_NAME
psql -h 127.0.0.1 -U $DB_USER  -f ./db/config.sql $DB_NAME
psql -h 127.0.0.1 -U $DB_USER  -f ./db/data/countries.sql $DB_NAME
psql -h 127.0.0.1 -U $DB_USER  -f ./db/data/default.sql $DB_NAME
