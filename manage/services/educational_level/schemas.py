...
class HippoEducationalLevelBase(BaseModel):
...
class HippoEducationalLevelCreate(HippoEducationalLevelBase):
    id: Optional[str] = None
    created: Optional[datetime] = datetime.now()
    last_modified: Optional[datetime] = datetime.now()  # Default to now if not provided
    name:str

class HippoEducationalLevelUpdate(HippoEducationalLevelBase):
    last_modified: Optional[datetime] = datetime.now()  # Default to now if not provided


class HippoEducationalLevelRead(HippoEducationalLevelBase):
    id: str
