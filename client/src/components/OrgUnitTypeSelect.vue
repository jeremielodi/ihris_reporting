...
import OrgUnitTypeService from '@/views/pages/manage/organization_unit_types/orgTypeService';

export default defineComponent({
    name: 'OrgUnitTypeSelect',
    components: { Dropdown },
    props: {
    ...
    async mounted() {
        const result = await OrgUnitTypeService.read(null, {});
