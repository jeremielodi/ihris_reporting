...
import Job_typeService from '@/views/pages/manage/job_type/job_type.service';

export default defineComponent({
    name: 'Job_typeServiceSelect',
    components: { Dropdown },
    props: {
...
<template>
    <div class="field" style="margin-top: 10px;">
        ...
        <div class="col-12" style="padding: 0px">
            <Dropdown :id="id" v-model="dropdownValue" filter :options="job_types" optionLabel="name" style="width: 100%" placeholder="Select" @change="onSelect" :class="{ 'p-invalid': showInvalidMsg }" />
        </div>
