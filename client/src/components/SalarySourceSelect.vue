...
import Salary_sourceService from '@/views/pages/manage/salary_source/salary_source.service';

export default defineComponent({
    name: 'Salary_sourceServiceSelect',
    components: { Dropdown },
    props: {
...
<template>
    <div class="field" style="margin-top:10px">
        ...
        <div class="col-12" style="padding: 0px">
            <Dropdown :id="id" v-model="dropdownValue" filter :options="salary_sources" optionLabel="name" style="width: 100%" placeholder="Select" @change="onSelect" :class="{ 'p-invalid': showInvalidMsg }" />
        </div>
