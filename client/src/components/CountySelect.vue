...
import CountyService from '@/views/pages/manage/county/county.service';

export default defineComponent({
    name: 'CountyServiceSelect',
    components: { Dropdown },
    props: {
...
<template>
    <div class="field" style="margin-top: 10px;">
        ...
        <div class="col-12" style="padding: 0px">
            <Dropdown :id="id" v-model="dropdownValue" filter :options="countys" optionLabel="name" style="width: 100%" placeholder="Select" @change="onSelect" :class="{ 'p-invalid': showInvalidMsg }" />
        </div>
