...
import EmployeeStatusService from '@/views/pages/manage/employee_status/employee_status.service';

export default defineComponent({
    name: 'EmployeeStatuseSelect',
    props: {
    ...
    async mounted() {
        const result = await EmployeeStatusService.read(null, {});
