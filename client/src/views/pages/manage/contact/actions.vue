...
export default defineComponent({
    ...
    methods: {
        ...
        closeDialog(result) {
            if (result) {
                this.$emit('reloadContactList', true);
            }
            this.display = false;
                    ...
                    items: [
                        {
                            ...
                            command: () => {
                                this.$router.push(`/manage/contact_create?id=${this.entity.id}`);
                            }
                        }
                    ]
                }
...
<template>
    <div style="text-align: right" :data-testid="actionId" :id="actionId">
        ...
        <ConfirmModal :contact="entity" :close="DeleteConfirmDialog" :display="displayConfirm"> </ConfirmModal>
    </div>
</template>
