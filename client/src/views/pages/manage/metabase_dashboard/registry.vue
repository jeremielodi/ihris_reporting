...
<template>
    <div class="card manage-container" style="height: 90vh">
        ...
        >
            <template #header>
                <h4>{{ $t('TREE.METABASE_DASHBOARD') }}</h4>
                <div class="flex justify-content-between flex-column sm:flex-row">
                    ...
                    <span>
                        <InputGroup>
                            ...
                            <Button :label="$t('FORM.BUTTONS.ADD')" @click="this.$router.push('/manage/dashboard_create')" icon="pi pi-plus" />
                        </InputGroup>
                    </span>
                </div>
            </template>
