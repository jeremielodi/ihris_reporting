...
export default defineComponent({
    ...
    methods: {
        ...
        closeDialog(result) {
            if (result) {
                this.$emit('reloadDistrictList', true);
            }
            this.display = false;
                    ...
                    items: [
                        {
                            ...
                            command: () => {
                                this.$router.push(`/manage/district_create?id=${this.entity.id}`);
                            }
                        }
                    ]
                }
...
<template>
    <div style="text-align: right" :data-testid="actionId" :id="actionId">
        ...
        <ConfirmModal :district="entity" :close="DeleteConfirmDialog" :display="displayConfirm"> </ConfirmModal>
    </div>
</template>
