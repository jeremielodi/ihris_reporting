...
import Contact_typeAction from './actions.vue';
import { FilterMatchMode } from '@primevue/core/api';

export default defineComponent({
    name: 'Contact_typeRegistry',
    data() {
        return {
            contact_types: [],
            selectedUser: null,
...
<Column field="actions" :header="$t('Actions')" style="width: 80px;">
        ...
        <div>
            <b> {{ contact_types.length }} {{ $t('TREE.CONTACT_TYPE') }} </b>
        </div>
    </div>
</template>
<style scoped>
