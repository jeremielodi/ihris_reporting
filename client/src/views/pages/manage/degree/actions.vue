...
export default defineComponent({
    ...
    methods: {
        ...
        DeleteConfirmDialog(result) {
            ...
            DegreeService.delete(this.entity.id)
                .then(() => {
                    ...
                    items: [
                        {
                            ...
                            command: () => {
                                this.$router.push(`/manage/degree_create?id=${this.entity.id}`);
                            }
                        }
                    ]
                }
...
<template>
    <div style="text-align: right" :data-testid="actionId" :id="actionId">
        ...
        <ConfirmModal :degree="entity" :close="DeleteConfirmDialog" :display="displayConfirm"> </ConfirmModal>
    </div>
</template>
