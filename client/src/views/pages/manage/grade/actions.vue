...
export default defineComponent({
    ...
    methods: {
        ...
        DeleteConfirmDialog(result) {
            ...
            GradeService.delete(this.entity.id)
                .then(() => {
                    ...
                    items: [
                        {
                            ...
                            command: () => {
                                this.$router.push(`/manage/grade_create?id=${this.entity.id}`);
                            }
                        }
                    ]
                }
...
<template>
    <div style="text-align: right" :data-testid="actionId" :id="actionId">
        ...
        <ConfirmModal :grade="entity" :close="DeleteConfirmDialog" :display="displayConfirm"> </ConfirmModal>
    </div>
</template>
