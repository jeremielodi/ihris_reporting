...
import SpecialitySelect from '@/components/SpecialitySelect.vue';
    ...
    methods: {
        ...
        validate() {
            const options = {
                ...
                parentError: this.specialityId ? this.specialityId == this.speciality.parent : true
            };
            let validKey = true;
        ...
        <form @submit.prevent="createSpeciality" style="width: 100%">
            <div class="grid">
                ...
                <div class="col-12 lg:col-5 xl:col-5 p-field">
                    ...
                    <SpecialitySelect
                        id="parent"
                        :value="speciality.parent"
                        label="FORM.LABELS.PARENT"
                        :required="false"
                        :onChange="
                            (value) => {
                                speciality.parent = value.id;
                            }
                        "
                        :validationTrigger="formSubmitted"
                    />
