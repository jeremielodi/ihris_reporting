...
export default defineComponent({
    ...
    methods: {
        ...
        DeleteConfirmDialog(result) {
            ...
            SpecialityService.delete(this.entity.id)
                .then(() => {
                    ...
                    items: [
                        {
                            ...
                            command: () => {
                                this.$router.push(`/manage/speciality_create?id=${this.entity.id}`);
                            }
                        }
                    ]
                }
...
<template>
    <div style="text-align: right" :data-testid="actionId" :id="actionId">
        ...
        <ConfirmModal :speciality="entity" :close="DeleteConfirmDialog" :display="displayConfirm"> </ConfirmModal>
    </div>
</template>
