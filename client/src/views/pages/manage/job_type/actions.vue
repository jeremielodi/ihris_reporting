...
export default defineComponent({
    ...
    methods: {
        ...
        closeDialog(result) {
            if (result) {
                this.$emit('reloadJob_typeList', true);
            }
            this.display = false;
                    ...
                    items: [
                        {
                            ...
                            command: () => {
                                this.$router.push(`/manage/job_type_create?id=${this.entity.id}`);
                            }
                        }
                    ]
                }
...
<template>
    <div style="text-align: right" :data-testid="actionId" :id="actionId">
        ...
        <ConfirmModal :job_type="entity" :close="DeleteConfirmDialog" :display="displayConfirm"> </ConfirmModal>
    </div>
</template>
